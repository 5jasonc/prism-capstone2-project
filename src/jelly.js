...
function addGeometry( geometry ) {
	...
	if (params.wireframe) {
		...
		let subJellyGeo = new THREE.SphereGeometry(14, params.segments, params.segments, 0, 6.283, 0, 1.9);
		// subMesh = new THREE.Mesh( subJellyGeo, wireframeMaterial );
		// scene.add(subMesh);
		// subMesh.scale.set(0.98,0.65,0.98)

		//Create lines out of mesh
